...
class ImageData:
    ...
    def setCalibratedImages(self, imageRGB, seperateBlobs, seperateBlobsUncalibrated):
        self.calibratedRGBImage = imageRGB
        self.seperateBlobs = seperateBlobs
        self.seperateBlobsUncalibrated = seperateBlobsUncalibrated
